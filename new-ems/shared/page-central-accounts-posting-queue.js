...
import { listCentralPostingQueue, postCentralAccountsHospitalDocument, postCentralAccountsInteriorsDocument, postCentralAccountsTransportDocument } from "./admin-api.js";
...
async function postDocument(financialDocumentId) {
  ...
  try {
    ...
    if (sourceModule === "hospital-projects" || family.startsWith("HOSPITAL_")) {
      await postCentralAccountsHospitalDocument(financialDocumentId);
    } else if (sourceModule === "interiors" || family === "INTERIOR_BILL") {
