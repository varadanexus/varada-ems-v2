...
function renderPage(agreements = []) {
  renderModuleContent(`
    <style>
      ...
      .legal-flow-list li{display:grid;grid-template-columns:34px minmax(0,1fr);gap:.65rem;align-items:start;border:1px solid rgba(148,163,184,.22);border-radius:8px;padding:.7rem;background:#111d31;color:#f8fafc}
      .legal-flow-list b{width:34px;height:34px;border-radius:8px;background:#07101f;color:#f7d774;display:grid;place-items:center}
      .legal-flow-list strong{color:#f8fafc}
      .legal-flow-list .muted{color:#a9bad0}
