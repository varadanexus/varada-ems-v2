import { bindFlowsView, renderFlowsView } from "./whatsapp-flow-builder.js";
...
function workspaceViewContent(view, connections, setupReady, profile) {
  ...
  if (view === "flows") return renderFlowsView({ flows: workspaceFlows.flows, escapeHtml });
...
async function renderDashboard() {
  ...
  if (view === "flows") bindFlowsView({ root: app, flows: workspaceFlows.flows, request: messagingRequest, onRefresh: renderDashboard, toast: showToast, escapeHtml });
  if (view === "contacts") {
