...
function templateBuilderDialog(readyConnections, selectedId) {
  ...
  return `<dialog class="wp-contact-dialog wp-template-dialog wp-template-builder" id="wpCreateTemplateDialog"><form method="dialog">
    ...
    <footer class="wp-template-builder-footer"><span>Save a workspace draft or submit the finished template to Meta.</span><div><button class="wp-secondary" type="submit" value="cancel" formnovalidate>Cancel</button><button class="wp-secondary" type="submit" value="draft" formnovalidate>Save draft</button><button class="wp-primary" type="submit" value="create">Submit to Meta</button></div></footer>
