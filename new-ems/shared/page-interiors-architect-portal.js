...
function bind() {
  ...
  document.querySelector("#switchPortalBtn")?.addEventListener("click", () => window.location.assign(ROUTES.EXTERNAL_PORTAL_SELECTOR));
