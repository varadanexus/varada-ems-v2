...
function connections() {
  ...
  const cards = tenants.map((tenant) => {
    ...
    const accessLabel = billing.allowed ? (billing.state === "trial" ? "trial_access" : "access_active") : "access_blocked";
