...
function renderPage() {
  renderModuleContent(`
    <style>
      ...
      .draft-section{border:1px solid rgba(148,163,184,.22);border-radius:8px;background:#111d31;padding:.85rem;display:grid;gap:.7rem}
      .draft-section h4{margin:0;color:#f8fafc}
      ...
      .draft-field label{font-weight:800;color:#dbeafe;font-size:.84rem}
      .draft-checks{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.55rem}
      .draft-checks label{display:grid;grid-template-columns:20px minmax(0,1fr);gap:.45rem;align-items:start;color:#dbeafe;font-weight:700}
      ...
      .legal-checklist li{border:1px solid rgba(148,163,184,.22);border-radius:8px;padding:.65rem;background:#111d31;color:#dbeafe}
