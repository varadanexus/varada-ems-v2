...
const BASE_CSS = `
  ...
  .mws-section{padding:1.15rem;border:1px solid rgba(148,163,184,.18);border-radius:18px;background:#0f1a30;margin-bottom:1rem}
  ...
  .mws-section-head h4{margin:0}.mws-section-head p{margin:.25rem 0 0;color:#9eb0c7;line-height:1.55}
  ...
  .mws-field input,.mws-field textarea,.mws-field select{width:100%;padding:.8rem .9rem;border-radius:12px;border:1px solid rgba(148,163,184,.18);background:#091221;color:#f8fafc;box-sizing:border-box}
  .mws-field textarea{resize:vertical;min-height:90px}.mws-field small{color:#8ca0b8;line-height:1.4}
  .mws-search{width:100%;padding:.78rem .9rem;border-radius:10px;border:1px solid rgba(148,163,184,.18);background:#0b1324;color:#e5edf8;box-sizing:border-box}
  ...
  .mws-list-row:hover{border-color:#d4b26a}
  .mws-list-mark{width:50px;height:50px;border-radius:12px;display:grid;place-items:center;background:#07101f;color:#f7d774;font-size:.72rem;font-weight:800}
  .mws-list-copy strong{display:block;font-size:.96rem}.mws-list-copy small{display:block;color:#9eb0c7;margin-top:.25rem}
  ...
  .mws-step{flex:1;min-width:150px;display:flex;gap:.65rem;align-items:center;padding:.75rem .85rem;border:1px solid rgba(148,163,184,.18);border-radius:12px;background:#0b1324;color:#c3d1e4;cursor:pointer;text-align:left}
  .mws-step.active{border-color:#d4b26a;background:rgba(212,178,106,.1)}
  .mws-step.disabled{opacity:.45;cursor:not-allowed}
  .mws-step-num{width:28px;height:28px;border-radius:50%;display:grid;place-items:center;background:#07101f;color:#f7d774;font-weight:800;font-size:.82rem;flex:0 0 auto}
  .mws-step.active .mws-step-num{background:#d4b26a;color:#07101f}
  .mws-step b{display:block;font-size:.86rem}.mws-step small{display:block;color:#8ca0b8;font-size:.72rem}
  .mws-kpis{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:.7rem;margin-bottom:1rem}
  .mws-kpi{padding:.85rem 1rem;border:1px solid rgba(148,163,184,.18);border-radius:14px;background:#0b1324}
  .mws-kpi span{display:block;color:#9eb0c7;font-size:.8rem}.mws-kpi strong{display:block;font-size:1.4rem;margin-top:.2rem}
  .mws-nav{display:flex;justify-content:space-between;gap:.6rem;margin-top:1rem}
  .mws-person{display:grid;gap:.2rem}.mws-mini{font-size:.76rem;color:#9eb0c7;margin-top:.2rem}
  ...
  .mws-note{padding:.85rem 1rem;border-radius:12px;background:#0b1324;border:1px dashed rgba(148,163,184,.22);color:#9eb0c7;line-height:1.5;margin-top:1rem}
...
function liveStep(meeting) {
  ...
  return `
    <section class="mws-section">
      <div class="mws-section-head">
        <div><h4>Live Room</h4><p>Control the session and open the host-controlled Jitsi room.</p></div>
        <div class="mws-actions">
          ...
          <a class="btn" href="${buildHostRoomLink(meeting.id)}">Open Host Room</a>
        </div>
      </div>
      <div class="mws-kpis">
