-- Sprint 7A: transport client billing permissions seed

with seed_modules(module_code) as (
  values ('transport-client-billing')
),
...
select m.module_code,
       a.action_code,
       'Transport Client Billing ' || initcap(a.action_code),
       true
from seed_modules m
...
join public.permissions p
  on p.module_code = 'transport-client-billing'
