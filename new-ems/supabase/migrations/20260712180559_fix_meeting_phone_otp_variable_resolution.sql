-- Recompile the already-deployed functions with explicit table-qualified
-- references. This preserves their signatures and grants while removing
-- ambiguity with identically named OUT parameters.
do $migration$
declare
  v_definition text;
begin
