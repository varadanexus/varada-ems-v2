-- Sprint 7D: payment tracking permissions seed

with seed_modules(module_code) as (
  values ('transport-client-receipts'), ('transport-transporter-payments')
),
...
join public.permissions p
  on p.module_code in ('transport-client-receipts', 'transport-transporter-payments')
