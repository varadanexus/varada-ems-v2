-- Sprint 7B: transporter statements permissions seed

with seed_modules(module_code) as (
  values ('transport-transporter-statements')
),
...
select m.module_code,
       a.action_code,
       'Transport Transporter Statements ' || initcap(a.action_code),
       true
from seed_modules m
...
join public.permissions p
  on p.module_code = 'transport-transporter-statements'
