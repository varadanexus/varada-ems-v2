-- Sprint 4.1 permission seed (non-destructive)
...
join public.permissions p on p.module_code in (
  'divisions','master-clients','master-contractors','master-transporters','master-agents',
  'master-commodities','master-routes','master-units','master-tax-codes','master-document-types'
)
