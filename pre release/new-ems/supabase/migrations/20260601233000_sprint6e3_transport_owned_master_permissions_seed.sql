-- Sprint 6E.3: transport-owned master module permissions (non-destructive)
...
join public.permissions p
  on p.module_code in ('transport-clients', 'transport-transporters', 'transport-commodities')
