...
function render() {
  ...
  renderModuleContent(`
    <style>
      ...
      .mt-settings-note .note{padding:.9rem;border:1px solid rgba(230,200,126,.14);border-radius:12px;background:linear-gradient(145deg,rgba(230,200,126,.035),#07080d)}
    ...
    <div class="mt-settings-grid">
      <section class="card">
        ...
        <div style="margin-top:.9rem;padding:.85rem;border:1px solid rgba(230,200,126,.14);border-radius:12px;background:linear-gradient(145deg,rgba(230,200,126,.035),#07080d);">
