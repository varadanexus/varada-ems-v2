...
function renderPage() {
  renderModuleContent(`
    <style>
      ...
      .legal-capture-box{border:1px solid rgba(230,200,126,.15);border-radius:14px;padding:.85rem;background:linear-gradient(145deg,rgba(230,200,126,.035),#07080d 65%);color:#c9c5b8}
      .legal-camera,.legal-photo{width:100%;aspect-ratio:4/3;object-fit:cover;background:#050609;border-radius:12px;border:1px solid rgba(230,200,126,.18)}
      ...
      .legal-status-grid div{border:1px solid rgba(230,200,126,.14);border-radius:12px;padding:.65rem;background:#07080d;color:#c9c5b8}
      .legal-status-grid strong{color:#f7f4ec}
      .legal-status-grid .muted{color:#9b9788}
