...
function renderShell() {
  ...
  renderModuleContent(`
    <style>
      ...
      .mr-room{border:1px solid rgba(230,200,126,.18);border-radius:18px;overflow:hidden;background:#050609;box-shadow:0 22px 58px rgba(0,0,0,.35)}
      .mr-canvas{height:min(72vh,760px);background:#050609}
      ...
      .mr-roster-row{padding:.8rem;border:1px solid rgba(230,200,126,.14);border-radius:12px;background:linear-gradient(145deg,rgba(230,200,126,.035),#07080d)}
      .mr-roster-row strong{display:block}
      .mr-roster-row small{display:block;margin-top:.25rem;color:#9b9788;line-height:1.45}
      ...
      .mr-meta{padding:.8rem;border:1px solid rgba(230,200,126,.14);border-radius:12px;background:linear-gradient(145deg,rgba(230,200,126,.035),#07080d)}
      .mr-meta strong{display:block;font-size:.75rem;letter-spacing:.08em;text-transform:uppercase;color:#e6c87e}
