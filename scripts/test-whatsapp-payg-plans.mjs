...
assert.match(portalHtml,/page-whatsapp-platform-portal\.js\?v=175/);
assert.equal(publicRouteHtml.length,29);
assert.ok(publicRouteHtml.every(html=>html.includes('/new-ems/shared/page-whatsapp-platform-portal.js?v=175')));
